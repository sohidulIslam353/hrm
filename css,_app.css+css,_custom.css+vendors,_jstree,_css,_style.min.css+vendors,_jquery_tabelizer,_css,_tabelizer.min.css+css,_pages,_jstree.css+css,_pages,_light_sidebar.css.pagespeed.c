@charset "UTF-8";
@import url(https://fonts.googleapis.com/css?family=Nunito+Sans:400,600|Roboto+Slab);
/*
| mint colors related code;'
*/
/*
| purple colors related code
*/
/*!
...
.btn {
  ...
  .btn:focus, .btn.focus {
    outline: 0;
    box-shadow: 0 0 0 2px rgba(50, 156, 255, 0.25); }
...
.btn-primary {
  ...
  .btn-primary:focus, .btn-primary.focus {
    box-shadow: 0 0 0 2px rgba(50, 156, 255, 0.5); }
...
.btn-info {
  ...
  .btn-info:focus, .btn-info.focus {
    box-shadow: 0 0 0 2px rgba(0, 123, 184, 0.5); }
...
.btn-success {
  ...
  .btn-success:focus, .btn-success.focus {
    box-shadow: 0 0 0 2px rgba(90, 202, 130, 0.5); }
...
.btn-warning {
  ...
  .btn-warning:focus, .btn-warning.focus {
    box-shadow: 0 0 0 2px rgba(252, 180, 16, 0.5); }
...
.btn-danger {
  ...
  .btn-danger:focus, .btn-danger.focus {
    box-shadow: 0 0 0 2px rgba(248, 106, 103, 0.5); }
...
.custom-control-input {
  ...
  .custom-control-input:focus ~ .custom-control-indicator {
    box-shadow: 0 0 0 1px #F5F9FB, 0 0 0 3px #329cff; }
...
a.bg-success:focus, a.bg-success:hover {
  background-color: #3bb667 !important; }
...
a.bg-warning:focus, a.bg-warning:hover {
  background-color: #d69603 !important; }

.bg-danger {
  background-color: #f86a67 !important; }

a.bg-danger:focus, a.bg-danger:hover {
  background-color: #f63a36 !important; }
...
.btn-mint {
  ...
  .btn-mint:focus, .btn-mint.focus {
    box-shadow: 0 0 0 2px rgba(49, 208, 214, 0.5); }
...
.btn-purple {
  ...
  .btn-purple:focus, .btn-purple.focus {
    box-shadow: 0 0 0 2px rgba(147, 126, 255, 0.5); }
...
.btn-outline-mint {
  ...
  .btn-outline-mint.disabled, .btn-outline-mint:disabled {
    color: #31d0d6;
    background-color: transparent; }
  .btn-outline-mint:active, .btn-outline-mint.active,
...
.badge-mint {
  background-color: #31d0d6; }
  .badge-mint[href]:focus, .badge-mint[href]:hover {
    background-color: #23acb1; }
...
button.list-group-item-mint {
  color: #ffffff; }
  a.list-group-item-mint .list-group-item-heading,
  button.list-group-item-mint .list-group-item-heading {
    color: inherit; }
  ...
  a.list-group-item-mint.active,
  button.list-group-item-mint.active {
    color: #fff;
    background-color: #ffffff;
    border-color: #ffffff; }
...
a.bg-purple:focus, a.bg-purple:hover {
  background-color: #684bff !important; }
...
.card-primary .card-blockquote small {
  color: #fff; }
...
.left_aside #menu{
    width: 250px;
    background-color: #fff;
    box-shadow: 3px 0 6px 0 rgba(0, 0, 0, 0.05),  -3px 2px 15px 2px rgba(0, 0, 0, 0.1);
}
.right-aside
{
    padding-top: 0 !important;
