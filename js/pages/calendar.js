...
$(document).ready(function() {
    ...
    ini_events($('#external_events div.external_event'));
    var evt_obj;
    ...
    $("#add_new_event").on('click',function(e) {
        ...
        event.css({
            ...
            "border-radius":'25px',
            "margin-top":'10px'
        }).addClass("external_event");
        event.html(val).append(' <i class="ti-close event_clear  float-right m-t-5" aria-hidden="true"></i>');
        $('#external_events').prepend(event);
    ...
    $("body").on("click", "#external_events .event_clear", function() {
        $(this).closest(".external_event").remove();
        return false;
    });
    $(".modal-dialog [data-dismiss='modal']").on('click', function() {
        $("#new_event").replaceWith('<input type="text" id="new_event" class="form-control" placeholder="Event">');
    });
